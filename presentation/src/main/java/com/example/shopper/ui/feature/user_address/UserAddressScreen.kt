...
fun UserAddressScreen(navController: NavController, userAddress: UserAddress?) {
    ...
    val addressLine = remember {
        mutableStateOf(userAddress?.addressLine.orEmpty())
    }
    val city = remember {
        mutableStateOf(userAddress?.city.orEmpty())
    }
    val state = remember {
        mutableStateOf(userAddress?.state.orEmpty())
    }
    val postalCode = remember {
        mutableStateOf(userAddress?.postalCode.orEmpty())
    }
    val country = remember {
        mutableStateOf(userAddress?.country.orEmpty())
    }
    ...
    Column(
        ...
        OutlinedTextField(
            value = addressLine.value, onValueChange = {
        ...
        OutlinedTextField(
            value = city.value, onValueChange = {
                city.value = it
            },
            label = {
                Text(text = "City")
        ...
        OutlinedTextField(
            value = postalCode.value, onValueChange = {
                postalCode.value = it
            },
            label = {
        ...
        OutlinedTextField(
            value = country.value, onValueChange = {
                country.value = it
            },
            label = {
                Text(text = "Country")
